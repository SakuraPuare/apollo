...
namespace apollo {
    namespace planning {
        ...
        piecewise_path.
        Append(theta1, kappa1, dkappa1, delta_s0
        );
        piecewise_path.
        Append(theta2, kappa2, dkappa2, delta_s1
        );

        EXPECT_NEAR(delta_s0
        + delta_s1, piecewise_path.

        ParamLength(),

        1.0e-8);
        EXPECT_NEAR(path0
        .Evaluate(0, 0.0), piecewise_path.Evaluate(0, 0.0), 1.0e-8);
        EXPECT_NEAR(path1
        .Evaluate(0, 0.0), piecewise_path.Evaluate(0, delta_s0),
        1.0e-8);
        EXPECT_NEAR(path1
        .Evaluate(0, path1.
        ...
        piecewise_path.Evaluate(0, piecewise_path.
