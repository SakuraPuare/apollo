...
namespace apollo {
    namespace planning {
        ...
        speed_decider.
        preferred_speed_ = 10.0;
        speed_decider.
        max_speed_ = 20.0;
        speed_decider.
        preferred_accel_ = 2.0;
        speed_decider.
        preferred_decel_ = 2.0;
        speed_decider.
        preferred_jerk_ = 2.0;
        speed_decider.
        max_accel_ = 5.0;
        ...
        max_decel_ = 5.0;
        speed_decider.
        obstacle_buffer_ = 1.0;
        speed_decider.
        safe_distance_base_ = 2.0;
        speed_decider.
        safe_distance_ratio_ = 1.0;
        speed_decider.
        ...
        speed_decider.
        hard_speed_limit_ = 100.0;
        speed_decider.
        hard_accel_limit_ = 10.0;
        speed_decider.
        ...
        path_points.
        emplace_back(GenPathPoint(0.0)
        );
        path_points.
        emplace_back(GenPathPoint(100.0)
        );

        SpeedData speed_data;

        EXPECT_EQ(Status::OK(), speed_decider
...
max_speed_ = 20.0;
speed_decider.
preferred_accel_ = 1.0;
speed_decider.
preferred_decel_ = 1.0;
speed_decider.
preferred_jerk_ = 2.0;
speed_decider.
max_accel_ = 5.0;
...
path_points.
emplace_back(GenPathPoint(200.0)
);
...
NaviSpeedDecider speed_decider;
speed_decider.
preferred_speed_ = 12.0;
speed_decider.
max_speed_ = 30.0;
speed_decider.
preferred_accel_ = 2.0;
speed_decider.
preferred_decel_ = 1.5;
speed_decider.
preferred_jerk_ = 2.0;
speed_decider.
max_accel_ = 5.0;
...
double s = 0.0;
path_points.
emplace_back(GenPathPoint(s, 0.0)
);
s += 50.0;
path_points.
emplace_back(GenPathPoint(s, 0.0)
...
s += 1.0;
path_points.
emplace_back(GenPathPoint(s, 0.03 * static_cast<double>(i))
);
}
for (
size_t i = 1;
...
s += 1.0;
path_points.
emplace_back(GenPathPoint(s, 0.15)
);
}
for (
size_t i = 1;
...
s += 1.0;
path_points.
emplace_back(GenPathPoint(s, -0.07)
);
}
for (
size_t i = 1;
