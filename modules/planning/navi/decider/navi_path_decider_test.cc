...
// dest lane
GeneratePathData(kMaxS,
0.03, 0.03, &path_points);
double dest_y = path_points[0].y();
double expect_y = path_points[0].y();
navi_path_decider.
MoveToDestLane(dest_y, &path_points
);
EXPECT_DOUBLE_EQ(path_points[0]
.
...
GeneratePathData(kMaxS,
0.90, 0.03, &path_points);
double dest_y = path_points[0].y();
double expect_y = path_points[0].y();
navi_path_decider.
KeepLane(dest_y, &path_points
);
EXPECT_DOUBLE_EQ(path_points[0]
.
