...
namespace apollo {
    namespace planning {
        ...
        vec_points.
        push_back(PointFactory::ToPathPoint(0.0, 0.0)
        );
        vec_points.
        push_back(PointFactory::ToPathPoint(0.0, 3.0, 0.0, 3.0)
        );
        vec_obstacle.
        emplace_back(&b1);
        ...
        b1.
        SetPerceptionSlBoundary(obstacle_boundary);
        path_decision.
        AddObstacle(b1);
    ...
    EXPECT_FLOAT_EQ(nudge_dist,
    0.755);
    EXPECT_FLOAT_EQ(lane_obstacles_num,
    1);
}
...
vec_points.
push_back(PointFactory::ToPathPoint(0.0, 0.0, 0.0, s1)
);
vec_points.
push_back(PointFactory::ToPathPoint(1.0, 1.0, 0.0, s2)
);
vec_points.
push_back(PointFactory::ToPathPoint(2.0, 2.0, 0.0, s3)
);
vec_points.
push_back(PointFactory::ToPathPoint(3.0, 3.0, 0.0, s4)
);
vec_points.
push_back(PointFactory::ToPathPoint(4.0, 4.0, 0.0, s5)
);
vec_obstacle.
emplace_back(&b1);
vec_obstacle.
...
vec_points.
push_back(PointFactory::ToPathPoint(0.0, 2.0, 0.0, s1)
);
vec_points.
push_back(PointFactory::ToPathPoint(1.0, 2.0, 0.0, s2)
);
vec_points.
push_back(PointFactory::ToPathPoint(2.0, 2.0, 0.0, s3)
);
vec_points.
push_back(PointFactory::ToPathPoint(3.0, 2.0, 0.0, s4)
);
vec_points.
push_back(PointFactory::ToPathPoint(4.0, 2.0, 0.0, s5)
);
vec_obstacle.
emplace_back(&b1);
vec_obstacle.
...
obstacle_decider.
GetUnsafeObstaclesInfo(vec_points, vec_obstacle
);
unsafe_obstacle_info = obstacle_decider.UnsafeObstacles();
EXPECT_EQ(std::get<0>(unsafe_obstacle_info[0]),
"5");
EXPECT_EQ(std::get<0>(unsafe_obstacle_info[1]),
"6");
EXPECT_EQ(std::get<1>(unsafe_obstacle_info[0]),
1.5);
EXPECT_EQ(std::get<1>(unsafe_obstacle_info[1]),
0.5);
EXPECT_EQ(std::get<2>(unsafe_obstacle_info[0]),
10);
EXPECT_EQ(std::get<2>(unsafe_obstacle_info[1]),
5);
}
