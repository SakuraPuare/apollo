...
namespace apollo {
    namespace planning {
        ...
        DEFINE_string(test_data_frame_file,
        "", "test data frame");
 ...
 */
        ...
        << "Failed to load data frame file " <<
        FLAGS_test_data_frame_file;
        ...
        BirdviewImgFeatureRenderer::Instance()->
        ...
        ACHECK(trajectory_imitation_libtorch_inference
        ->
