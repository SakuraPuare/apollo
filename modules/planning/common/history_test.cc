...
namespace apollo {
    ...
    // seq_num: 1
    history_->
    Add(adc_trajectory_1);
    EXPECT_NE(nullptr, history_
    ->

    GetLastFrame()

    );
    EXPECT_EQ(1, history_->
...
: object_decisions) {
ADEBUG << "object_decision[" << object_decision->
...
for (
const ObjectDecisionType *decision_type
: obj_decision) {
ADEBUG << "  decistion_type[" << decision_type->
...
// 11720: nudge, stop
EXPECT_STREQ("11720", object_decisions[0]->
...
EXPECT_EQ(2, obj_decision.

size()

);
// sort
std::sort(obj_decision
.
...
EXPECT_TRUE(obj_decision[0]
->

has_stop()

);
EXPECT_TRUE(obj_decision[1]
->
...
// CW_2832: stop
EXPECT_STREQ("CW_2832", object_decisions[1]->
...
// TL_2516: stop
EXPECT_STREQ("TL_2516", object_decisions[2]->
...
EXPECT_STREQ("11720", object_decision->
