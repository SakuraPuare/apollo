...
namespace apollo {
    ...
    ASSERT_EQ(5, indexed_obstacles_.
    ...
    EXPECT_TRUE(indexed_obstacles_
    .Find("2156_0"));
    EXPECT_TRUE(indexed_obstacles_
    .Find("2156_1"));
    EXPECT_TRUE(indexed_obstacles_
...
EXPECT_EQ("2156_0", obstacle->

Id()

);
EXPECT_EQ(2156, obstacle->
...
EXPECT_DOUBLE_EQ(0.0, first_point.

relative_time()

);
EXPECT_DOUBLE_EQ(76.684071405, first_point.
...
EXPECT_DOUBLE_EQ(350.481852505, first_point.
...
EXPECT_DOUBLE_EQ(10.0441531943, last_point.

relative_time()

);
EXPECT_DOUBLE_EQ(186.259371951, last_point.
...
EXPECT_DOUBLE_EQ(341.853799387, last_point.
...
EXPECT_LE(3.68968892853, middle_point.

relative_time()

);
EXPECT_GE(3.89467164678, middle_point.

relative_time()

);
EXPECT_GE(139.091700103, middle_point.
...
EXPECT_LE(135.817210975, middle_point.
...
EXPECT_GE(349.875902219, middle_point.
...
EXPECT_LE(349.549888973, middle_point.
...
EXPECT_DOUBLE_EQ(3.8324769804600001, box.

length()

);
EXPECT_DOUBLE_EQ(1.73200099013, box.

width()

);
EXPECT_DOUBLE_EQ(76.684071405, box.

center_x()

);
EXPECT_DOUBLE_EQ(350.481852505, box.

center_y()

);
EXPECT_DOUBLE_EQ(0.00531211859358, box.
...
EXPECT_DOUBLE_EQ(83.2581699369, box.

center_x()

);
EXPECT_DOUBLE_EQ(350.779556678, box.

center_y()

);
EXPECT_DOUBLE_EQ(0.040689919196199999, box.
...
EXPECT_DOUBLE_EQ(74.766181894499994, points[0].

x()

);
EXPECT_DOUBLE_EQ(350.72985818299998, points[0].

y()

);
EXPECT_DOUBLE_EQ(74.783198034400002, points[1].

x()

);
EXPECT_DOUBLE_EQ(350.32601568799998, points[1].

y()

);
EXPECT_DOUBLE_EQ(74.770555729799995, points[15].

x()

);
EXPECT_DOUBLE_EQ(350.878567223, points[15].
...
EXPECT_EQ(2156, perception_obstacle.
...
EXPECT_EQ("abc", obstacle->

Id()

);
EXPECT_EQ(-314721735, obstacle->

PerceptionId()

);
EXPECT_TRUE(obstacle
->
...
EXPECT_DOUBLE_EQ(0.0, perception_box.
...
EXPECT_DOUBLE_EQ(4.0, perception_box.

length()

);
EXPECT_DOUBLE_EQ(2.0, perception_box.
...
EXPECT_EQ(2,
Obstacle::MergeLongitudinalDecision(decision_overtake1,
        decision_overtake2
)
.
...
EXPECT_EQ(-2,
Obstacle::MergeLongitudinalDecision(decision_follow1,
        decision_follow2
)
.
...
EXPECT_EQ(
-2,
Obstacle::MergeLongitudinalDecision(decision_yield1, decision_yield2
)
.
...
set_type(ObjectNudge::LEFT_NUDGE);
...
decision_nudge2.mutable_nudge()->
set_type(ObjectNudge::RIGHT_NUDGE);
}
