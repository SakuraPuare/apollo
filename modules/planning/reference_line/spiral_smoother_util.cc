...
"", "input file with format x,y per line");
DEFINE_string(output_file,
"", "output file with format x,y per line");
DEFINE_double(smooth_length,
200.0, "Smooth this amount of length ");
DEFINE_double(minimum_point_spacing,
5.0,
